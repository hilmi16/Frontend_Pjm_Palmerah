...
class StatusPesananDetail extends StatefulWidget {
  final StatusPesananModel model;
  StatusPesananDetail(this.model);
  @override
  _StatusPesananDetailState createState() => _StatusPesananDetailState();
}

class _StatusPesananDetailState extends State<StatusPesananDetail> {
